...
- **Test hoặc query tôi đã dùng:** `pytest tests/` 41/41 pass (5 contract test phần B, 7 test PageIndex, 6 test bonus); smoke test Chroma; chạy lại Task 3 ra data giống hệt từng byte; RAGAS A/B (`run_eval.py`, cùng generator `gpt-4o-mini`) trước và sau khi sửa.
